<template>
  <footer
    class="pt-10 bg-[#0F6075] text-white transition-colors duration-300"
  >
...
<div class="md:text-right text-center">
  ...
  <div class="flex justify-center md:justify-start gap-3 mt-4">
    ...
    <a
      ...
      target="_blank" rel="noopener" class="soc" aria-label="Facebook"
    >
...
>
  <svg viewBox="0 0 32 32" width="16" height="16" fill="none">
    ...
    <a
      ...
      target="_blank" rel="noopener" class="soc" aria-label="X"
    >
      <svg viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
    ...
    <a
      ...
      target="_blank" rel="noopener" class="soc" aria-label="YouTube"
    >
      <svg viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
