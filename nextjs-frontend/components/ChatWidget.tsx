...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`fixed z-40 flex flex-col transition-all duration-300 overflow-hidden shadow-2xl 
        ...
        >
          {/* الهيدر */}
          <div className="flex items-center justify-between px-4 py-3 bg-[#0A8096] dark:bg-gray-800 text-white">
          ...
          <div
            ...
            className="flex-1 px-4 py-5 overflow-y-auto bg-[#F4F7F8] dark:bg-gray-900"
            dir="rtl"
          >
                ...
                {msg.type === 'user' ? (
                  <div className="mb-4 flex justify-end">
                    <div className="flex flex-col items-end max-w-[75%]">
                      ...
                      {msg.timestamp && (
                        <span className="mt-1 text-[10px] text-slate-500 dark:text-gray-400">
                    ...
                    {!msg.loading ? (
                      <div className="flex flex-col items-end">
                        <div className="flex items-start gap-2">
                          {/* الأيقونة */}
                          <div className="w-8 h-8 rounded-full bg-white dark:bg-gray-700 border border-slate-300 dark:border-gray-600 flex items-center justify-center overflow-hidden shrink-0">
                            <Image
                              src="/assets/images/chat-icon.png"
                              alt="bot icon"
                              width={32}
                          ...
                          {/* فقاعة الرد */}
                          <div className="max-w-[75%] rounded-2xl rounded-tr-none px-4 py-3 text-sm shadow bg-white dark:bg-gray-800 text-slate-900 dark:text-gray-100 text-right">
                            <div className="whitespace-pre-wrap">{msg.text}</div>
                          </div>
                        </div>
                        {msg.timestamp && (
                          <span className="mt-1 text-[10px] text-slate-500 dark:text-gray-400 text-right w-full pr-10">
                      ...
                      <div className="flex justify-start mt-1">
                        <div className="ml-10 max-w-[70%] rounded-2xl rounded-tl-none px-4 py-2 text-sm shadow bg-white/80 dark:bg-gray-800/80 text-slate-700 dark:text-gray-200 text-right">
                          جاري الكتابة ...
                        </div>
                      </div>
                    )}
          ...
          {showSuggestions && suggestedQuestions.length > 0 && (
            <div className="px-4 pt-3 pb-4 bg-[#F4F7F8] dark:bg-gray-900 border-t border-slate-200/0" dir="rtl">
          ...
          {/* إدخال الرسائل */}
          <div className="border-t border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3" dir="rtl">
            <div className="relative">
              <input
                ...
                className="w-full rounded-3xl border border-slate-300 dark:border-gray-600 
                bg-[#F8FCFF] dark:bg-gray-800 
                pr-12 pl-4 py-3 text-sm 
                text-slate-700 dark:text-gray-100 outline-none"
