    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-600 px-8 py-5">
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-transparent outline-none border-0 border-b border-slate-300 dark:border-slate-500 pb-1 text-sm text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500"
        />
