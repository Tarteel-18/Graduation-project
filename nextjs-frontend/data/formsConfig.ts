export const formsConfig: Record<string, any> = {
  'promote-project': {
    ...
    fields: [
      {
        ...
        options: ['صغيرة', 'متناهية الصغر', 'مشاريع صغيرة / أسر منتجة'],
        required: false,
      },
      {
        name: 'entity',
  ...
  'volunteer-program': {
    ...
    fields: [
      ...
      { name: 'city', type: 'text', label: 'مكان الإقامة', required: true },
      { name: 'age', type: 'number', label: 'العمر', required: true },
      { name: 'favField', type: 'text', label: 'المجال المفضل', required: false },
    ],
  },
  ...
  'specs-memo-request': {
    ...
    description: 'نحن هنا لدعمك والإجابة على استفساراتك حول المشاريع الصغيرة والأصغر. بملء هذه الاستمارة يمكنك طلب مذكرة المواصفات والمقاييس لمشروعك.',
    fields: [
      {
        name: 'projectType',
        type: 'radio',
